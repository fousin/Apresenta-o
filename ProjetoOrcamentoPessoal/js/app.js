...
function cadastrarDespesa(){
    ...
    if(despesa.validarDados()){
        ...
        document.getElementById('modalConteudo').innerHTML = 'A despesa foi cadasatrada com sucesso'
        document.getElementById('modalBtn').innerHTML = 'Voltar'
        document.getElementById('modalBtn').className = 'btn btn-success'

        //limpar campos dps de concluido
        ano.value=''
        mes.value=''
        dia.value=''
        tipo.value=''
        ...
        document.getElementById('modalConteudo').innerHTML = 'Erro na gravação, verifique se todos os campos estão preenchidos corretamente'
...
function carregaListaDespesas(despesas = Array(), filtro = false){
    ...
    //percorrer o array dispesas, listando cada item 
